...
quality_gates:
  pre_output:
    - name: factual_grounding
      ...
      message: "All claims must be grounded"
      severity: error
    - name: bias_check
      check: "{{ output.perspectives >= 2 }}"
      message: "Consider multiple perspectives"
      severity: warning
  post_output:
    - name: consistency
...
Tests all quality gate types: pre_output, post_output, invariants, and self_verification.
